...
echo "<section class='likedmarkets'>";
    ...
    while ($row = mysqli_fetch_array($q)) {
        ...
        echo "<center><button class='button'><a href='add_product.html' class='link'><span>Add Product </span></a></button></center>";
        echo "</div>";

        echo '<button class="button backtohomebutton"><a href="index.php" class="link"><span>Back To Home Page</span></a></button>';
        echo '<button class="button logoutbutton"><a href="logout.php" class="link"><span>Log out</span></a></button>';
        mysqli_close($db);
